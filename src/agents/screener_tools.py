...
# Tool functions defined as plain functions — wrapping with FunctionTool
# happens in screeni_agent._setup_agent() to avoid the import shadowing
# conflict between our local src/agents/ and the openai-agents 'agents' package.
